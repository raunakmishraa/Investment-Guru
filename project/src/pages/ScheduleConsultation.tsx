      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-accent-900 mb-6">
            Schedule Your
            <span className="bg-gradient-to-r from-primary-600 to-secondary-600 bg-clip-text text-transparent"> Free Consultation</span>
          </h1>
          
          <p className="text-xl text-accent-600 max-w-3xl mx-auto mb-8">
            Take the first step towards your financial success. Book a complimentary consultation 
            with our expert investment advisors and discover personalized strategies for your goals.
          </p>

          {/* Benefits */}
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            {[
              { icon: Target, title: 'Personalized Strategy', desc: 'Tailored investment plan for your goals' },
              { icon: CheckCircle, title: 'Expert Guidance', desc: '15+ years of investment experience' },
              { icon: DollarSign, title: 'No Obligation', desc: 'Completely free with no strings attached' }
            ].map((benefit, index) => (
              <motion.div
                key={benefit.title}
              ...
              >
                ...
                <h3 className="font-semibold text-accent-900 mb-1">{benefit.title}</h3>
        ...
        {submitStatus === 'success' && (
          ...
          >
            ...
            <div>
              <h3 className="text-green-800 font-semibold mb-2">Consultation Scheduled Successfully!</h3>
              <p className="text-green-700">
                Thank you for scheduling your free consultation. Our team will contact you within 24 hours 
                to confirm your appointment and provide meeting details.
              </p>
            </div>
          </motion.div>
        )}
        ...
        >
          <div className="flex items-center mb-8">
            ...
            <div>
              <h2 className="text-2xl font-bold text-accent-900">Book Your Appointment</h2>
              <p className="text-accent-600">Fill out the form below and we'll get back to you shortly</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    <Mail size={18} className="absolute left-3 top-1/2 transform -translate-y-1/2 text-accent-400" />
                    <input
                      type="email"
                      id="email"
                      name="email"
                ...
                <div>
                  ...
                  <div className="relative">
                    <Phone size={18} className="absolute left-3 top-1/2 transform -translate-y-1/2 text-accent-400" />
                    <input
                      type="tel"
                      id="phone"
                      name="phone"
            ...
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="preferredDate" className="block text-sm font-medium text-accent-700 mb-2">
                    Preferred Date *
                  </label>
                  <input
                    type="date"
                ...
                <div>
                  <label htmlFor="preferredTime" className="block text-sm font-medium text-accent-700 mb-2">
                    Preferred Time *
                  </label>
                  <select
                    id="preferredTime"
                ...
                <div className="md:col-span-2">
                  <label htmlFor="consultationType" className="block text-sm font-medium text-accent-700 mb-2">
                    Consultation Type *
                  </label>
                  <div className="relative">
                    <Building size={18} className="absolute left-3 top-1/2 transform -translate-y-1/2 text-accent-400 z-10" />
                    <select
                      id="consultationType"
            ...
            <div>
              ...
              <div className="space-y-6">
                <div>
                  <label htmlFor="investmentGoals" className="block text-sm font-medium text-accent-700 mb-2">
                    Investment Goals *
                  </label>
                  <textarea
                    id="investmentGoals"
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="riskTolerance" className="block text-sm font-medium text-accent-700 mb-2">
                      Risk Tolerance *
                    </label>
                    <select
                      id="riskTolerance"
                  ...
                  <div>
                    <label htmlFor="investmentAmount" className="block text-sm font-medium text-accent-700 mb-2">
                      Investment Amount Range
                    </label>
                    <div className="relative">
                      <DollarSign size={18} className="absolute left-3 top-1/2 transform -translate-y-1/2 text-accent-400" />
                      <select
                        id="investmentAmount"
                ...
                <div>
                  <label htmlFor="currentInvestments" className="block text-sm font-medium text-accent-700 mb-2">
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  <label htmlFor="hearAboutUs" className="block text-sm font-medium text-accent-700 mb-2">
